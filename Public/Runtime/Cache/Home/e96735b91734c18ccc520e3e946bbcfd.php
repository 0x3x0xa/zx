...
<body>
    <article class="page-container">
        <form action="/index.php/Home/Member/useradd.html" method="" class="form form-horizontal registerform" id="form-member-add">
            {__TOKEN__} 
            <fieldset style="border: 1px solid #56b4f3; border-radius: 9px;">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-7 col-sm-5">
                        <input type="text" class="input-text username" value="<?php echo ($username); ?>" placeholder="" ajaxurl="<?php echo U('/Home/Member/check_input_unique');?>"  errormsg="会员账号格式不对" nullmsg="请输入会员账号！"  id="username" name="username"  datatype="u6-16" >
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-7 col-sm-5">
                        <input type="text" value='<?php echo ($userInfo["username"]); ?>' class="input-text recommend" placeholder=""   ajaxurl="<?php echo U('/Home/Member/check_input_recommend_exist');?>" name="recommend" id="recommend" errormsg="账号至少6个字符,最多18个字符！" nullmsg="请输入推荐人账号！" datatype="s6-18">
                    </div>
                    <div class="Validform_checktip"></div>
                </div>
                <div class="row cl">
