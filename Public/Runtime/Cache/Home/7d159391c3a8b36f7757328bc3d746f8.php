...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 财务中心 <span class="c-gray en">&gt;</span>奖金提现列表  <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<form method="get" action="/index.php/Home/Report/listcashreq.html">
<div class="pd-20">
  <div class="text-c">
  ...
  <div class="cl pd-5 bg-1 bk-gray mt-20">
      <span class="l"> 
          <button type="button" class="btn btn-success excel" id="" onClick="showPage('600','550','添加提现','<?php echo U('Report/addWithdrawals');?>')" href="javascript:;" ><i class="Hui-iconfont">&#xe600;</i> 添加提现</button>
<!--           <button type="button" class="btn btn-success excel" id="" onClick="showPage('600','350','合并到动态钱包','<?php echo U('Report/mergedongtaimoney');?>')" href="javascript:;" ><i class="Hui-iconfont">&#xe63a;</i> 合并到动态钱包</button>
           <button type="button" class="btn btn-success excel" id="" onClick="showPage('600','350','合并到静态钱包','<?php echo U('Report/mergejingtaimoney');?>')" href="javascript:;" ><i class="Hui-iconfont">&#xe63a;</i> 合并到静态钱包</button>-->
      </span>
  ...
  <table class="table table-border table-bordered table-hover table-bg table-sort">
	...
	<td class="text-l"><?php echo ($vo["truemoney"]); ?></td>
