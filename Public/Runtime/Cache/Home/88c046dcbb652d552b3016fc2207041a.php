...
<form method="get" action="/index.php/Home/Orders/listaudited.html">
	...
	<table class="table table-border table-bordered table-hover table-bg ">
		...
		<td class="text-l"><?php echo ($vo["status"]); ?></td>
                <td>
                <a title="订单详情" href="javascript:void(0);" onClick="showPage('700','500','查看订单详情','<?php echo U('Orders/detailOrder',array('id'=>$vo['id']));?>')" class="ml-5" style="text-decoration:none">订单详情</a>
                </td>
