...
<title></title>
<body>  
     <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 基本信息 <span class="c-gray en">&gt;</span> 重置密码 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	...
	<form action=""  class="form form-horizontal SubmiForm" id="form-article-add"  >
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-5 col-sm-4">
                ...
                <div class="row cl">
			<label class="form-label col-xs-4 col-sm-4" style='text-align:right;'><span class="c-red">*</span>短信验证码：</label>
			<div class="formControls col-xs-5 col-sm-4">
					<input type="text" class="input-text code" placeholder="" name="code"  value=""  style='width:100px;'   nullmsg='请输入手机验证码' datatype="*">
