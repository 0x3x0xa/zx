...
<body>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>财务中心 <span class="c-gray en">&gt;</span>汇款充值 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">
        <form method="get" action="/index.php/Home/Report/remittancelist.html">
            <div class="text-c"> 
                <span class="select-box" style='width:130px;'>
                    <select name="search_status"  class='select' >
                        <option value=""> 选择状态</option>
                        <option value="1" <?php if($arr['search_status'] == '1' ): ?>selected="selected"<?php endif; ?> >未发放</option>
                        <option value="2" <?php if($arr['search_status'] == '2' ): ?>selected="selected"<?php endif; ?> >已审核</option>
                        <option value="3" <?php if($arr['search_status'] == '3' ): ?>selected="selected"<?php endif; ?> >已发放</option>
                        <option value="4" <?php if($arr['search_status'] == '4' ): ?>selected="selected"<?php endif; ?> >已拒绝</option>
                    </select> 
                </span>
                日期范围：
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l"> <button type="button" class="btn btn-success excel" id="" onClick="showPage('600', '450', '添加汇款通知', '<?php echo U('Report/addRemit');?>')" href="javascript:;" ><i class="Hui-iconfont">&#xe600;</i> 添加汇款通知</button></span>
        ...
        <div class="mt-0">
            <table class="table table-border table-bordered table-hover table-bg ">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                        <td class="text-l"> <?php echo ($vo["bank"]); ?></td>
                        <td class="text-l"><?php echo ($vo["receive"]); ?></td>
                        <td class="text-l"><?php echo ($vo["bankno"]); ?></td>
                        <td class="text-l"><?php echo ($vo["remitter"]); ?></td>
                        <td class="text-l"><?php echo ($vo["money"]); ?></td>
                        <td class="text-l"><?php echo (date("Y-m-d H:i:s",$vo["create_date"])); ?></td>
                        <td class="text-l"><?php if($vo["status"] == "1" ): ?>未发放<?php elseif($vo["status"] == "2" ): ?>已经审核 <?php elseif($vo["status"] == "3" ): ?>已经发放<?php else: ?>拒绝发放<?php endif; ?></td>
