...
<body>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>财务中心 <span class="c-gray en">&gt;</span>我的客户<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">
        <form method="get" action="/index.php/Home/Member/recommend.html">
            <div class="text-c"> 
        ...
        <div class="mt-0">
            <table class="table table-border table-bordered table-hover table-bg ">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c"> 
                        ...
                        <td class="text-c"><?php echo ($vo["level"]); ?></td>
                        <td class="text-c" style="width:120px;"><?php echo (date("Y-m-d H:i:s",$vo["regtime"])); ?></td>
                        <td class="text-c" style="width:100px;"> <?php if($vo["junction"] == "-1" ): ?><a  style="color: #367cb7;;" href="javascript:void(0);" onclick="showPage('600', '280', '会员升级', '<?php echo U("Home/Member/reupgrade",array('username'=>$vo['username']));?>')">会员升级</a> <a style="color: #367cb7;;" href='javascript:;'  onclick="del('<?php echo ($vo['username']); ?>')" >删除</a><?php else: ?>已完成<?php endif; ?></td>
