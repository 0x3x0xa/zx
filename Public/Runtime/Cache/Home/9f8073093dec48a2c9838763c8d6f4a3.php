        ...
        <table class="table  table-border table-bordered table-hover table-bg">
            <tbody> 
                ...
                <tr>
                    ...
                    <td class="text-l" style="width:70%"><?php echo ($level["title"]); ?></td>
                </tr>
            ...
            <?php if($userInfo["saveinfonum"] == '0' ): ?>{__TOKEN__} 
            <tr>
                <th class="text-r" style="width:30%">身份证：</th>
                <td class="text-l" style="width:70%">
                   
	 <input type="text" value=" <?php echo ($userInfo["id_card"]); ?>" class="input-text id_card" placeholder="" name="id_card" id="id_card" errormsg="您填写的身份证号码不对！" nullmsg="请填写身份证号码！" datatype="idcard">
            ...
            <tr>
                ...
                <td class="text-l" style="width:70%">
                    <input type="text" class="input-text post_code" value="  <?php echo ($userInfo["post_code"]); ?>" placeholder="" id="post_code" name="post_code" errormsg="邮政编码格式不正确！"  nullmsg='请输入邮政编码' datatype="yb-6">
            ...
            <tr>
                ...
                <td class="text-l" style="width:70%">
                      <input type="text"  class="input-text detailed_address" placeholder="" value="<?php echo ($userInfo["detailed_address"]); ?>" name="detailed_address" id="detailed_address" errormsg="详细地址不正确！"  nullmsg='请输入详细地址' datatype="xxdz">
		</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="text-l" style="width:70%">
                       <input type="text" class="input-text account_name" value="  <?php echo ($userInfo["account_name"]); ?>" placeholder="" id="account_name" name="account_name" errormsg="中文名为2~4个中文字符！" nullmsg="请输入中文名！" datatype="z2-4">
            ...
            <tr>
                ...
                <td class="text-l" style="width:70%">
                      <input type="text" class="input-text bankno" value="  <?php echo ($userInfo["bankno"]); ?>" placeholder="" id="bankno" name="bankno" errormsg="银行账号16或19个字符！" nullmsg="请输入银行账号！" datatype="yhno-16-19">
            ...
            <tr>
                ...
                <td class="text-l" style="width:70%">
                 <input type="text" class="input-text bank_outlets" value="<?php echo ($userInfo["bank_outlets"]); ?>" placeholder="" id="bank_outlets" name="bank_outlets" errormsg="" nullmsg="请设置银行网点！" datatype="*">
            ...
            <tr>
                <th class="text-r" style="width:30%">邮政编码：</th>
                <td class="text-l" style="width:70%"> 
                    <?php echo ($userInfo["post_code"]); ?>
                  </td>
            </tr>
            <tr>
                <th class="text-r" style="width:30%">所在地区：</th>
                <td class="text-l" style="width:70%">  
                    <?php echo ($userInfo["province"]); ?>&nbsp;<?php echo ($userInfo["city"]); ?>&nbsp;<?php echo ($userInfo["area"]); ?>  
		</td>
            ...
            <tr>
                <th class="text-r" style="width:30%">详细地址：</th>
                <td class="text-l" style="width:70%">
                    <?php echo ($userInfo["detailed_address"]); ?>
		</td>
            </tr>
            <tr>
                <th class="text-r" style="width:30%">开户银行：</th>
                <td class="text-l" style="width:70%">
                    <?php echo ($userInfo['bank']); ?>
                </td>
            </tr>
            <tr>
                <th class="text-r" style="width:30%">开户姓名：</th>
                <td class="text-l" style="width:70%">
                    <?php echo ($userInfo["account_name"]); ?>
                  </td>
            </tr>
            <tr>
                <th class="text-r" style="width:30%">银行卡号：</th>
                <td class="text-l" style="width:70%"> 
                    <?php echo ($userInfo["bankno"]); ?>
                  </td>
            </tr> 
            <tr>
                <th class="text-r" style="width:30%">银行网点：</th>
                <td class="text-l" style="width:70%"><?php echo ($userInfo["bank_outlets"]); ?>
                </td>
            </tr><?php endif; ?>
            </tbody>
        </table>
