...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>订单管理 <span class="c-gray en">&gt;</span>已完成订单 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<table class="table table-border table-bordered table-hover table-bg ">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-l">
                <td><?php echo ($vo["order_eg"]); ?></td>
                <td class="text-l"><?php echo ($vo["total_num"]); ?></td>
                <td class="text-l"><?php echo ($vo["total_sum"]); ?></td>
		<td class="text-l"><?php echo ($vo["status"]); ?></td>
                <td>
                <a title="订单详情" href="javascript:;" onClick="showPage('700','500','查看订单详情','<?php echo U('Orders/detailOrder',array('id'=>$vo['id']));?>')" class="ml-5" style="text-decoration:none">订单详情</a>
