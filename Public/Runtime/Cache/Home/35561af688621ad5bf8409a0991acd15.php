...
<body>
    ...
    <div class="page-container">
        <form method="get" action="/index.php/Home/Report/paylist.html">
            <div class="text-c"> 
                <span class="select-box" style='width:130px;'>
                    <select name="search_status"  class='select' >
                        <option value=""> 选择状态</option>
                        <option value="1" <?php if($arr['search_status'] == '1' ): ?>selected="selected"<?php endif; ?> >充值成功</option>
                        <option value="2" <?php if($arr['search_status'] == '2' ): ?>selected="selected"<?php endif; ?> >充值失败</option>
                    </select> 
                </span>
                日期范围：
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            <span class="l"> <button type="button" class="btn btn-success excel" id="" onClick="showPage('600', '350', '充值', '<?php echo U('Report/pay');?>')" href="javascript:;" ><i class="Hui-iconfont">&#xe600;</i> 充值</button></span>
        ...
        <div class="mt-0">
            <table class="table table-border table-bordered table-hover table-bg ">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                        ...
                        <td class="text-l"><?php echo ($vo["billno"]); ?></td>
                        <td class="text-l"><?php echo ($vo["amount"]); ?></td>
                        <td class="text-l"><?php echo (date("Y-m-d H:i:s",$vo["create_date"])); ?></td>
                        <td class="text-c"><?php if($vo["status"] == "1" ): ?>成功付款<?php elseif($vo["status"] == "2" ): ?>等待付款&nbsp;&nbsp;<a href='http://<?php echo ($url); ?>/Home/Pays/newpay?billno=<?php echo ($vo["billno"]); ?>' target='_blank' style='color:blue' >去付款  </a><?php endif; ?></td>
