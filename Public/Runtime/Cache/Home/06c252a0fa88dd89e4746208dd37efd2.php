...
<body>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>财务中心 <span class="c-gray en">&gt;</span>市场业绩汇总<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">
        <form method="get" action="/index.php/Home/Report/listnewpv.html">
            <div class="text-c"> 
        ...
        <div class="mt-0">
            <table class="table table-border table-bordered table-hover table-bg ">
                <thead>
                    <tr class="text-c">
                        <th width="">左区 日新增业绩</th>
                        <th width="">中区 日新增业绩</th>
                        <th width="">右区 日新增业绩</th>
                        <th width="">日总新增业绩</th>
                        <th width="">日期</th>
                    </tr>
                </thead>
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                        <td class="text-c"><?php echo ($vo["leftgroupmoney"]); ?></td>
                        <td class="text-c"><?php echo ($vo["centergroupmoney"]); ?></td>
                        <td class="text-c"><?php echo ($vo["rightgroupmoney"]); ?></td>
                        <td class="text-c"><?php echo ($vo["totalmoney"]); ?></td>
                        <td class="text-c"><?php echo (date("Y-m-d ",$vo["create_date"])); ?></td>
