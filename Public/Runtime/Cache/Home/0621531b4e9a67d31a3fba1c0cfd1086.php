...
<body>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>财务中心 <span class="c-gray en">&gt;</span>市场业绩明细<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    <div class="page-container">
        <form method="get" action="/index.php/Home/Report/listnewtotal.html">
            <div class="text-c"> 
        ...
        <div class="mt-0">
            <table class="table table-border table-bordered table-hover table-bg ">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                        ...
                        <td class="text-c"><?php if($vo["type"] == 0): ?>左区<?php elseif($vo["type"] == 1): ?>中区<?php elseif($vo["type"] == 2): ?>右区<?php endif; ?></td>
                        <td class="text-c"><?php echo ($vo["money"]); ?></td>
                        <td class="text-c"><?php echo (date("Y-m-d H:i:s",$vo["create_date"])); ?></td>
