        ...
        <form action=""  class="form form-horizontal SubmiForm" id="form-article-add"  >
            <div class="row cl">
                ...
                <div class="formControls col-xs-5 col-sm-4">
                    <input type="text" class="input-text price" value="<?php echo ($data["price"]); ?>"  placeholder="" id="" name="price"  nullmsg='不能为空' datatype='*' >
                </div>
                <div class="Validform_checktip"></div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-4" style="text-align: right;"><span class="c-red">*</span>月：</label>
                <div class="formControls col-xs-5 col-sm-4">
                           <input  type="text" id="datemin"  class="input-text Wdate"  onfocus="WdatePicker({Date:'%y-%M-{%d-7}'})" nullmsg='不能为空' datatype='*'  value='<?php echo (date("Y-m-d",$data["week"])); ?>'/> 
                </div>
                <div class="Validform_checktip"></div>
            </div>
