...
<div class="page-container">
	...
	<span class="l"> <a href="javascript:;" onClick="showPage('660','300','添加银行','<?php echo U('Webconfig/bankadd');?>')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加银行</a></span> 
	...
	<table class="table table-border table-bordered table-hover table-bg ">
		...
		<a style="text-decoration:none" onClick="bank_stop(this,'<?php echo ($vo["id"]); ?>')" href="javascript:;" title=""><i class="Hui-iconfont">&#xe6e1;</i></a><?php endif; ?>
		<a title="编辑" href="javascript:;" onClick="showPage('660','300','修改','<?php echo U('Webconfig/bankedit',array('id'=>$vo['id']));?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
