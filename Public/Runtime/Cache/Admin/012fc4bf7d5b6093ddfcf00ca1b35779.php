...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 财务管理 <span class="c-gray en">&gt;</span> 未处理提现<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<form method="get" action="/index.php/Admin/Report/listapproved.html">
<div class="pd-20">
  <div class="text-c">
  ...
  <table class="table table-border table-bordered table-hover table-bg table-sort">
	...
	<td class="text-c"><?php echo ($status[$vo[status]]); ?></td>
        <td class="user-status">
            <a href="javascript:void(0);" onclick="tixiangongguo(<?php echo ($vo["id"]); ?>)">审核通过</a>
            <a href="javascript:void(0);" onclick="tixianjujue(<?php echo ($vo["id"]); ?>)">拒绝通过</a>
        </td>
