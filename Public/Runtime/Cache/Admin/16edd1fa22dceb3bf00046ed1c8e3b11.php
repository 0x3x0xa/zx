...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		<div id="tab-system" class="HuiTab">
			<div class="tabBar cl"><span>基本设置</span><span>安全设置</span><!--<span>邮件设置</span>--><span>短信设置</span></div>
			<div class="tabCon">
				<div class="row cl">
					...
					<label>
                            ...
                            <div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>登录超时：</label>
					<div class="formControls col-xs-8 col-sm-9">
					<label>
                                                <input name="overtime" type="radio" id="six_1" value="1"   <?php if($config["overtime"] == 1): ?>checked<?php endif; ?> >
                                              开启</label>
                                               <label>
                                           <input type="radio" name="overtime" value="0" id="six_0" <?php if($config["overtime"] == 0): ?>checked<?php endif; ?>>
                                           关闭</label>
					</div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="website-title" placeholder="" value="<?php echo ($config["weburl"]); ?>" class="input-text weburl">
					</div>
				</div>
				<div class="row cl">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="website-description" placeholder="空制在80个汉字，160个字符以内" value="<?php echo ($config["description"]); ?>" class="input-text description">
                                ...
                                <div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>服务热线：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="website-description" placeholder="" value="<?php echo ($config["hottel"]); ?>" class="input-text hottel">
					</div>
				</div>
			...
			<div class="tabCon">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						...
						<div class="tabCon">
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">短信发送开关：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<label><input name="sms_status" value="1" <?php if($config["sms_status"] == 1 ): ?>checked<?php endif; ?> type="radio">&nbsp;开&nbsp;启</label>&nbsp;&nbsp;
						<label><input name="sms_status" value="0" <?php if($config["sms_status"] == 0 ): ?>checked<?php endif; ?> type="radio">&nbsp;关&nbsp;闭</label>
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">短信账号：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="" value="<?php echo ($config["smsusername"]); ?>" class="input-text smsusername" placeholder="">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">短信密码：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="password" class="input-text smspwd" value="<?php echo ($config["smspwd"]); ?>"  placeholder="25" name="smspwd" >
					</div>
				</div>
			</div>
		</div>
