...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 财务管理 <span class="c-gray en">&gt;</span> 审核汇款充值  <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<form method="get" action="/index.php/Report/listshenhe.html">
<div class="pd-20">
  <div class="text-c">
  ...
  <table class="table table-border table-bordered table-hover table-bg table-sort">
	...
	<td><?php echo ($vo["bankno"]); ?></td>
        <td><?php echo ($vo["remitter"]); ?></td>
        <td><?php echo ($vo["money"]); ?></td>
        <td><?php echo ($vo["remittance_date"]); ?></td>
         <td><?php echo (date("Y-m-d H:i:s",$vo["create_date"])); ?></td>
	<td><?php if($vo["status"] == "1" ): ?>未发放<?php elseif($vo["status"] == "2" ): ?>已经审核 <?php elseif($vo["status"] == "3" ): ?>已经发放<?php else: ?>拒绝发放<?php endif; ?></td>
        <td ><?php echo ($vo["message"]); ?></td>
        <td width="120"> <a href="javascript:void(0);" onclick="shenPiRemittance(<?php echo ($vo["id"]); ?>)" >审核通过</a> <a href="javascript:void(0);"  onclick="jujieRemittance(<?php echo ($vo["id"]); ?>)">拒绝通过</a> </td>
