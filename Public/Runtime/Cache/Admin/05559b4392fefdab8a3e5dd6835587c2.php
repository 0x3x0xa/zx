...
<form method="get" action="/index.php/Admin/Orders/listsended.html">
	<div class="text-c"> 
...
<!--           <span class="select-box" style='width:140px;'>
	...
	<table class="table table-border table-bordered table-hover table-bg ">
		...
		<!--<td class="text-l"><?php echo ($vo["adminname"]); ?></td>-->
                ...
                <td class="text-l"><?php echo (date('Y-m-d H:i:s',$vo["fahuotime"])); ?></td>
		...
		<td class="text-l"><?php echo ($vo["total_sum"]); ?></td>
                <td class="text-l"><?php echo ($vo["achievement"]); ?></td>
		<td class="text-l"><?php echo ($vo["status"]); ?></td> 
                ...
                <a title="查看" href="javascript:;" onClick="showPage('900','500','查看订单详情','<?php echo U('Orders/detailOrder',array('id'=>$vo['id']));?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe695;</i></a>
               	<a title="收货" href="javascript:;" onClick="order_shouhuo(this,<?php echo ($vo["id"]); ?>)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe692</i></a>
                <a title="编辑" href="javascript:;" onClick="showPage('900','500','查看物流','<?php echo U('Orders/wuliu',array('id'=>$vo['id']));?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe669;</i></a> 
		</td>
