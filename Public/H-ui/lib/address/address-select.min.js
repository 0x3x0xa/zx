function create_address_select(e, g, n, p, q, r) {
	...
	if ("object" == typeof g) var d = g.province,
		a = g.capital,
		c = g.city;
	else t.innerHTML = "<select datatype='*' nullmsg='请选择省份'   name='" + e + "Province' id='" + e + "Province' class='select province' style='margin-bottom:5px;height:31px;line-height:31px;width:33%' ></select><select datatype='*' nullmsg='请选择城市' name='" + e + "Capital' id='" + e + "Capital' class='select city' style='margin-bottom:5px;height:31px;line-height:31px;width:33%'  ></select><select datatype='*' nullmsg='请选择地区' name='" + e + "City' id='" + e + "City' class='select area' style='margin-bottom:5px;height:31px;line-height:31px;width:33%' ></select>", d = document.getElementById(e + "Province"), a = document.getElementById(e + "Capital"), c = document.getElementById(e + "City");
	d.add_option = k;
	d.clear_options = l;
	d.addr = "province";
	d.bind_data = h;
